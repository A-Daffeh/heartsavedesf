        ...
        <Row className="g-4 mt-4">
            ...
            <Card className="h-100 shadow-sm border-0">
              <Card.Body>
                <div className="d-flex align-items-center justify-content-between">
                  <h6 className="fw-bold mb-0" style={{ color: "var(--brand-primary)" }}>House Rules</h6>
                  <Badge bg="light" text="dark">PDF</Badge>
                </div>
                <p className="text-muted small mt-2 mb-3">
                  Full expectations for residence, safety, and routines.
                </p>
                <Button
                  href="/docs/ESF-House-Rules.pdf"
                  download
                  className="w-100 btn-outline-brand"
                  variant="outline-success"
                >
                  <FileArrowDown className="me-2" /> Download
                </Button>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={4}>
            <Card className="h-100 shadow-sm border-0">
              <Card.Body>
                <div className="d-flex align-items-center justify-content-between">
                  <h6 className="fw-bold mb-0" style={{ color: "var(--brand-primary)" }}>Resident Rights</h6>
                  <Badge bg="light" text="dark">PDF</Badge>
                </div>
                <p className="text-muted small mt-2 mb-3">
                  Detailed rights and responsibilities for residents and families.
                </p>
                <Button
                  href="/docs/Resident-Rights.pdf"
                  download
                  className="w-100 btn-outline-brand"
                  variant="outline-success"
                >
          ...
          <Col md={4}>
            <Card className="h-100 shadow-sm border-0">
              <Card.Body>
                <div className="d-flex align-items-center justify-content-between">
                  <h6 className="fw-bold mb-0" style={{ color: "var(--brand-primary)" }}>Admissions Overview</h6>
                  <Badge bg="light" text="dark">PDF</Badge>
                </div>
                <p className="text-muted small mt-2 mb-3">
                  Steps, eligibility, and what to expect during intake.
                </p>
                <Button
                  href="/docs/Admissions-Overview.pdf"
                  download
                  className="w-100 btn-outline-brand"
                  variant="outline-success"
                >
